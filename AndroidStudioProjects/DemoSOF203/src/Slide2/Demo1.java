...
public class Demo1 {
    public static void main(String[] args) {
        ...
        ImageIcon usIcon = new ImageIcon("E:\\IconSlide2\\america-usa.png");
        ImageIcon amIcon = new ImageIcon("E:\\IconSlide2\\united-kingdom.png");
        ImageIcon vnIcon = new ImageIcon("E:\\IconSlide2\\VietNam.png");
        JPanel p = new JPanel();
